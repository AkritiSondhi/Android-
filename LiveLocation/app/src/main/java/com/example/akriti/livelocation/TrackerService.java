...
public class TrackerService extends Service implements LocationListener {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "10";
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Log.d("msg", task.getException().getLocalizedMessage());
    ...
    private GoogleApiClient.ConnectionCallbacks mLocationRequestCallback = new GoogleApiClient
        ...
        public void onConnected(Bundle bundle) {
            ...
            if (ActivityCompat.checkSelfPermission(TrackerService.this, Manifest.permission.ACCESS_FINE_LOCATION)
                    != PackageManager.PERMISSION_GRANTED &&
                    ActivityCompat.checkSelfPermission(TrackerService.this, Manifest.permission.ACCESS_COARSE_LOCATION)
                            != PackageManager.PERMISSION_GRANTED) {
                // permission already checked in activity
                return;
            }
            ...
            mWakelock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "TrackerApp: MyWakelockTag");
