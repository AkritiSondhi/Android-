...
public class TrackerActivity extends AppCompatActivity {
    ...
    private void checkInputFields() {
        if (mTransportIdEditText.length() == 0 || mEmailEditText.length() == 0 ||
            ...
            Toast.makeText(TrackerActivity.this, R.string.missing_inputs,
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        switchCustomer.setVisible(true);
        switchDriver.setVisible(false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_switch_customer:
                startActivity(new Intent(TrackerActivity.this, CustomerActivity.class));
                return true;
    ...
    private void updateTrackingButtons(boolean tracking) {
        mStartButton.setVisibility(tracking ? View.GONE : View.VISIBLE);
        mStopButton.setVisibility(tracking ? View.VISIBLE : View.GONE);
    }
}
